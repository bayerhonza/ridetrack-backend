...
import static com.ensimag.ridetrack.auth.roles.RoleType.ADMIN;
import static com.ensimag.ridetrack.auth.roles.RoleType.CLIENT;
import static com.ensimag.ridetrack.auth.roles.RoleType.GUEST;
import static com.ensimag.ridetrack.auth.roles.RoleType.USER;
...
/**
 * Configuration of method security to enable method-security annotations
 */
